...
setSearch({
  openBtnClass: "header__search-open",
  // класс кнопки открытия
  closeBtnClass: "header__search-form-close",
  // класс кнопки закрытия
  searchClass: "header__search-form",
  // класс формы поиска
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.contacts__right-form', rules1, afterForm);
var rules2 = [{
  ruleSelector: '.input-mail',
  rules: [{
    rule: 'required',
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.about__right-form', rules2, afterForm2);
